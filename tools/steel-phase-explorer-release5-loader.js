  ...
  <div class="spx-r5-layout">
    <section class="spx-card spx-r5-main-card">
      <div class="spx-card-pad">
        <div class="spx-card-title"><div><h2 id="spx-r5-title">Rapid-quench microconstituent map</h2><p id="spx-r5-subtitle">Source-faithful portrait reconstruction with interactive inspection.</p></div><div class="spx-toolbar"><button class="spx-btn primary" id="spx-r5-export" type="button">Export high-resolution PNG</button><button class="spx-btn" id="spx-r5-example" type="button">Load examples</button></div></div>
        ...
        <div class="spx-r5-points-head"><div><h3>Comparison points</h3><p>Click or drag inside the calibrated graph rectangle to move the active point. Points are retained when switching references.</p></div><div class="spx-toolbar"><button class="spx-btn primary" id="spx-r5-add" type="button">+ Add point</button><button class="spx-btn" id="spx-r5-remove" type="button">Remove active</button></div></div>
